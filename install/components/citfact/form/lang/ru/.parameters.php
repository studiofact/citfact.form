...
$MESS['USE_CSRF'] = 'Использовать CSRF';
$MESS['CACHE_GROUPS'] = 'Учитывать права доступа';
$MESS['REDIRECT_PATH'] = 'УРЛ адрес для перенаправления после успешного оформления';
$MESS['ALIAS_FIELDS'] = 'Словарь для замены стандартных наименований полей';
$MESS['DISPLAY_FIELDS'] = 'Словарь со списком полей которые нужно отобразить, если пустой отображаются все';
